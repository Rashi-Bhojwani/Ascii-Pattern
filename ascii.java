...
public class ascii 
{
    ...
    static void Charac() {
        ...
        char c[];
        String s1 = JOptionPane.showInputDialog("Enter a Character(Only one character)");
    ...
    static void Word() {
        ...
        char c[];
        String s1 = JOptionPane.showInputDialog("Enter a Word(Without Space)");
        for(int i=0;i<5;i++){
    ...
    static void Sentance() {
        System.out.println("Sentence ASCII--");
        char c[];
        String s1 = JOptionPane.showInputDialog("Enter a Sentence");
        for(int i=0;i<5;i++){
            for(int k=0; k<s1.length();k++){
                char ch = s1.charAt(k);
                if(ch == ' '){
    ...
    static void Range() {
        ...
        char c[];
        String s1 = JOptionPane.showInputDialog("Enter a Range(Except @ . - _ )");
